  ...
  return (
    <>
      ...
      <button
        ...
        className="fixed bottom-6 right-6 z-40 flex items-center gap-2 rounded-full border border-[var(--accent)]/40 bg-[var(--accent)]/15 px-4 py-2.5 text-sm font-semibold text-[var(--accent)] shadow-lg backdrop-blur-sm transition-all hover:bg-[var(--accent)]/25 hover:shadow-xl"
        title="Send feedback"
      >
